...
namespace FelicityStore_IrinaOrban.Utilities
{
    public class FrameworkConstants
    {
        ...
        static Dictionary<string, string> configData = MyUtils.ReadConfig("config.properties");
        ...
        public static bool startMaximized = Boolean.Parse(configData["starmaximized"]);
