...
namespace FelicityStore_IrinaOrban.Test
{
    class RegistrationTests: BaseTest
    {
        ...
        [Test,Category("Registration"), TestCaseSource("GetPersonRegistrationDataCsv")]
        public void PersonRegistration(string email, string emailErr, string password, string passwordErr, string confirmPassword, string confirmPasswordErr, string name, string nameErr, string phone, string phoneErr, string countyOptionIndex, string countyErr, string localityOptionIndex, string localityErr, string street, string streetErr,  string acceptTerms, string acceptTermsErr)
        {
            ...
            var errors = registrationPage.PersonRegistration(email, password, confirmPassword, name, phone, int.Parse(countyOptionIndex), int.Parse(localityOptionIndex), street,bool.Parse(acceptTerms));
        ...
        public void CompanyRegistration(string email, string emailErr, string password, string passwordErr, string confirmPassword, string confirmPasswordErr, string companyName, string companyNameErr, string companyCui, string companyCuiErr, string companyRegistrationCode,string companyRegistrationCodeErr,string companyCountyOptionIndex,  string companyCountyErr, string companyLocalityOptionsIndex, string companyLocalityErr, string companyStreet,string companyStreetErr, string name, string nameErr, string phone, string phoneErr, string countyOptionIndex, string countyErr, string localityOptionIndex, string localityErr, string street, string streetErr, string acceptTerms, string acceptTermsErr)
        {
            ...
            registrationPage.AcceptCookies();
            Assert.AreEqual("Creeaza Cont", registrationPage.CheckRegistrationPage());
            var errors = registrationPage.CompanyRegistration(email, password, confirmPassword,companyName,companyCui,companyRegistrationCode,int.Parse(companyCountyOptionIndex),int.Parse(companyLocalityOptionsIndex),companyStreet, name, phone, int.Parse(countyOptionIndex), int.Parse(localityOptionIndex), street, bool.Parse(acceptTerms));
            Assert.AreEqual(emailErr, errors["emailError"]);
            Assert.AreEqual(passwordErr, errors["passwordError"]);
            Assert.AreEqual(confirmPasswordErr, errors["confirmPasswordError"]);
