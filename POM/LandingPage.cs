...
namespace FelicityStore_IrinaOrban.POM
{
    public class LandingPage : BasePage
    {
        ...
        const string acasaLinkSelector = "#ctl00_MenuTop > ul > li:nth-child(1) > a";//CSS
        ...
        const string myAccountLinkSelector = "#ctl00_LoginViewMasterPage1_LoginView1_HyperLinkMyaccount1 > span:nth-child(2)";//CSS
        ...
        const string textBoxSearchSelector = "ctl00_txtSearchTextn";//ID
        ...
        const string bijuteriiArgintLinkSelector = "#HomeBanners > div:nth-child(6) > a > img";//CSS
        const string giftCardLinkSelector = "#HomeBanners > div.HomeBannersTab2 > a:nth-child(1)";//css
        const string citesteMaiMultLinkSelector = "#ctl00_ContentPlaceHolderBody_DepartmentDetailsPageContent1_ProductDescription > div.show-more > a";//CSS
        ...
        public bool CheckHeaderLinks()
        {
            ...
            {
                var linkElement = MyUtils.WaitForElement(driver,5,By.CssSelector(link));
        ...
        public bool CheckDynamicLinks( string linkName)
        {
            ...
            switch (linkName)
            {
                case "pandantive":
                    {
                        var linkElement = MyUtils.WaitForElement(driver,5,By.CssSelector(pandantiveLinkSelector));
                ...
                case "cercei":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(cerceiLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
                ...
                case "bratari":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(bratariLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
                ...
                case "butoni":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(butoniLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
                ...
                case "inele":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(ineleSiBroseLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
                ...
                case "bijuterii":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(bijuteriiArgintLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
                ...
                case "giftCard":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(giftCardLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
                ...
                case "povestea":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(povesteaNoastraLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
                ...
                case "blog":
                    {
                        var linkElement = MyUtils.WaitForElement(driver, 5, By.CssSelector(articoleBlogLinkSelector));
                        var linkHref = linkElement.GetAttribute("href");
                        linkNavigationFailed = MyUtils.CheckLinkNavigation(linkElement, driver, linkHref);
                        break;
        ...
        public bool CheckCaruselBijuteriiRecomandate()
        {
            ...
            for (int i=0; i<numberOfElementsInCarusel; i++)
            {
                ...
                var currentElement = MyUtils.WaitForElement(driver, 10, By.CssSelector(newItemCssSelector));
                ...
                currentElement = MyUtils.WaitForElement(driver, 10, By.CssSelector(newItemCssSelector));
